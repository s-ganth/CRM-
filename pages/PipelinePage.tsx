     ...
     useEffect(() => {
        const fetchDeals = async () => {
            ...
            try {
                ...
                console.error("Failed to fetch deals for pipeline", error);
            } finally {
                setIsLoading(false);
            }
        }
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-wrap gap-4 justify-between items-center">
                <h1 className="text-3xl font-bold text-text">Sales Pipeline</h1>
                <button
            ...
            {isLoading ? <div className="text-center p-10">Loading pipeline...</div> : <KanbanBoard columns={columns} onCardClick={handleCardClick} onItemMove={handleDealMove} />}
